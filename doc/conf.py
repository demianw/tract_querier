...
release = str(tract_querier.__version__)
...
html_static_path = ['documents', 'images']
...
def setup(app):
    ...
    class WMQLLexer(PythonLexer):
        EXTRA_KEYWORDS = (
            [pos + '_of' for pos in ['anterior', 'posterior', 'inferior', 'superior']] +
            ['endpoints_in']
        )
